...
public class Pet3 : CharacterBase
{
    ...
    public override void SmallSkill()
    {
        ...
        {
            //造成攻击力加护甲值的伤害
            BattleManager.Instance.units[target].TakeDamage(attack + defense);
        }
    }
    ...
    public override void BigSkill()
    {
        ...
        else
        {
            ...
            defense += 10;
            ChangeUI();
            BattleManager.Instance.units[target].TakeDamage(Mathf.FloorToInt(attack + defense));
        }
    }
